...
def define_EOMs(m,BW,lambEOMx_board,lambEOMy_board,lambEOMth_board,lambEOMxb_bipod,lambEOMyb_bipod,lambEOMthb_bipod,
               lambEOMthll_bipod,lambEOMthlr_bipod,lambEOMrl_bipod,lambEOMrr_bipod):
    # EOMS OF SKATEBOARD -------------------------------------------------------------------------------------------------------
    def EOMx_board(m,n):
    ...
    def EOMxb_bipod(m,n):
        ...
        # list the model versions of all quantities in the same order as sym_list
        var_list = [m.g,m.m[('body',1)],m.m[('left_leg',1)],m.m[('left_leg',2)],m.m[('right_leg',1)],m.m[('right_leg',2)],
                    m.len[('body',1)],m.len[('left_leg',1)],m.len[('left_leg',2)],m.len[('right_leg',1)],m.len[('right_leg',2)],
                    m.In[('body',1)],m.In[('left_leg',1)],m.In[('left_leg',2)],m.In[('right_leg',1)],m.In[('right_leg',2)],
                    m.q[n,'xb'],m.q[n,'yb'],m.q[n,'thb'],m.q[n,'thl_l'],m.q[n,'r_l'],m.q[n,'thl_r'],m.q[n,'r_r'],
                    m.dq[n,'xb'],m.dq[n,'yb'],m.dq[n,'thb'],m.dq[n,'thl_l'],m.dq[n,'r_l'],m.dq[n,'thl_r'],m.dq[n,'r_r'],
                    m.ddq[n,'xb'],m.ddq[n,'yb'],m.ddq[n,'thb'],m.ddq[n,'thl_l'],m.ddq[n,'r_l'],m.ddq[n,'thl_r'],m.ddq[n,'r_r'],
                    F_a_l_in, F_a_r_in, tau_a_l_in, tau_a_r_in, GRFx_l_in, GRFy_l_in, GRFx_r_in, GRFy_r_in]
        return lambEOMxb_bipod(*var_list) == 0
    m.EOMxb_bipod = Constraint(m.N, rule = EOMxb_bipod)
    ...
    def EOMyb_bipod(m,n):
        ...
        var_list = [m.g,m.m[('body',1)],m.m[('left_leg',1)],m.m[('left_leg',2)],m.m[('right_leg',1)],m.m[('right_leg',2)],
                    ...
                    m.ddq[n,'xb'],m.ddq[n,'yb'],m.ddq[n,'thb'],m.ddq[n,'thl_l'],m.ddq[n,'r_l'],m.ddq[n,'thl_r'],m.ddq[n,'r_r'],
                    F_a_l_in, F_a_r_in, tau_a_l_in, tau_a_r_in, GRFx_l_in, GRFy_l_in, GRFx_r_in, GRFy_r_in]
        return lambEOMyb_bipod(*var_list) == 0
    m.EOMyb_bipod = Constraint(m.N, rule = EOMyb_bipod)

    def EOMthb_bipod(m,n):
        GRFx_l_in = BW*m.GRFbf[n,'BF','X']
        GRFx_r_in = BW*m.GRFbf[n,'FF','X']
        GRFy_l_in = BW*m.GRFbf[n,'BF','Y']
        GRFy_r_in = BW*m.GRFbf[n,'FF','Y']
        ...
        var_list = [m.g,m.m[('body',1)],m.m[('left_leg',1)],m.m[('left_leg',2)],m.m[('right_leg',1)],m.m[('right_leg',2)],
                    ...
                    m.ddq[n,'xb'],m.ddq[n,'yb'],m.ddq[n,'thb'],m.ddq[n,'thl_l'],m.ddq[n,'r_l'],m.ddq[n,'thl_r'],m.ddq[n,'r_r'],
                    F_a_l_in, F_a_r_in, tau_a_l_in, tau_a_r_in, GRFx_l_in, GRFy_l_in, GRFx_r_in, GRFy_r_in]
        return lambEOMthb_bipod(*var_list) == 0
    m.EOMthb_bipod = Constraint(m.N, rule = EOMthb_bipod)

    def EOMthll_bipod(m,n):
        GRFx_l_in = BW*m.GRFbf[n,'BF','X']
        GRFx_r_in = BW*m.GRFbf[n,'FF','X']
        GRFy_l_in = BW*m.GRFbf[n,'BF','Y']
        GRFy_r_in = BW*m.GRFbf[n,'FF','Y']
        ...
        var_list = [m.g,m.m[('body',1)],m.m[('left_leg',1)],m.m[('left_leg',2)],m.m[('right_leg',1)],m.m[('right_leg',2)],
                    ...
                    m.ddq[n,'xb'],m.ddq[n,'yb'],m.ddq[n,'thb'],m.ddq[n,'thl_l'],m.ddq[n,'r_l'],m.ddq[n,'thl_r'],m.ddq[n,'r_r'],
                    F_a_l_in, F_a_r_in, tau_a_l_in, tau_a_r_in, GRFx_l_in, GRFy_l_in, GRFx_r_in, GRFy_r_in]
        return lambEOMthll_bipod(*var_list) == 0
    m.EOMthll_bipod = Constraint(m.N, rule = EOMthll_bipod)
    ...
    def EOMrl_bipod(m,n):
        ...
        var_list = [m.g,m.m[('body',1)],m.m[('left_leg',1)],m.m[('left_leg',2)],m.m[('right_leg',1)],m.m[('right_leg',2)],
                    ...
                    m.ddq[n,'xb'],m.ddq[n,'yb'],m.ddq[n,'thb'],m.ddq[n,'thl_l'],m.ddq[n,'r_l'],m.ddq[n,'thl_r'],m.ddq[n,'r_r'],
                    F_a_l_in, F_a_r_in, tau_a_l_in, tau_a_r_in, GRFx_l_in, GRFy_l_in, GRFx_r_in, GRFy_r_in]
        return lambEOMrl_bipod(*var_list) == 0
    m.EOMrl_bipod = Constraint(m.N, rule = EOMrl_bipod)

    def EOMthlr_bipod(m,n):
        GRFx_l_in = BW*m.GRFbf[n,'BF','X']
        GRFx_r_in = BW*m.GRFbf[n,'FF','X']
        GRFy_l_in = BW*m.GRFbf[n,'BF','Y']
        GRFy_r_in = BW*m.GRFbf[n,'FF','Y']
        ...
        var_list = [m.g,m.m[('body',1)],m.m[('left_leg',1)],m.m[('left_leg',2)],m.m[('right_leg',1)],m.m[('right_leg',2)],
                    ...
                    m.ddq[n,'xb'],m.ddq[n,'yb'],m.ddq[n,'thb'],m.ddq[n,'thl_l'],m.ddq[n,'r_l'],m.ddq[n,'thl_r'],m.ddq[n,'r_r'],
                    F_a_l_in, F_a_r_in, tau_a_l_in, tau_a_r_in, GRFx_l_in, GRFy_l_in, GRFx_r_in, GRFy_r_in]
        return lambEOMthlr_bipod(*var_list) == 0
    m.EOMthlr_bipod = Constraint(m.N, rule = EOMthlr_bipod)
    ...
    def EOMrr_bipod(m,n):
        ...
        var_list = [m.g,m.m[('body',1)],m.m[('left_leg',1)],m.m[('left_leg',2)],m.m[('right_leg',1)],m.m[('right_leg',2)],
                    ...
                    m.ddq[n,'xb'],m.ddq[n,'yb'],m.ddq[n,'thb'],m.ddq[n,'thl_l'],m.ddq[n,'r_l'],m.ddq[n,'thl_r'],m.ddq[n,'r_r'],
                    F_a_l_in, F_a_r_in, tau_a_l_in, tau_a_r_in, GRFx_l_in, GRFy_l_in, GRFx_r_in, GRFy_r_in]
        return lambEOMrr_bipod(*var_list) == 0
    m.EOMrr_bipod = Constraint(m.N, rule = EOMrr_bipod)
...
#     opt.options["linear_solver"] = 'ma86'
    ...
    opt.options["max_cpu_time"] = 20*60 # maximum cpu time in seconds
...
def print_results(m,N, ground_constraints, contact_constraints, joint_constraints, joints, Fs, legs):
    ...
    for n in range(1,N+1):
        ...
        force_sum  += m.F_a[n,'BL'].value**2 + m.F_a[n,'FL'].value**2
        torque_sum += m.tau_a[n,'BL'].value**2 + m.tau_a[n,'FL'].value**2
...
def make_animation(m, Ns, maxForce, maxGRF, maxGRFbf, maxF_a):
    N = Ns[0]
    #animate it
    ...
    def plot_board(i,m,ax): #update function for animation
        ...
        leg1_xt = body_xb
        leg1_yt = body_yb
        leg1_xb = body_xb + m.len[('left_leg',1)]*sin(m.thA[i,'BL'].value)
        leg1_yb = body_yb - m.len[('left_leg',1)]*cos(m.thA[i,'BL'].value)
        ...
        leg2_xt = body_xb + Lt*sin(m.thA[i,'BL'].value)
        leg2_yt = body_yb - Lt*cos(m.thA[i,'BL'].value)
        ...
        leg1_xt = body_xf
        leg1_yt = body_yf
        leg1_xb = body_xf + m.len[('right_leg',1)]*sin(m.thA[i,'FL'].value)
        leg1_yb = body_yf - m.len[('right_leg',1)]*cos(m.thA[i,'FL'].value)
        ax.plot([leg1_xt,leg1_xb],[leg1_yt,leg1_yb],color='k')
        ...
        leg2_xt = body_xf + Lt*sin(m.thA[i,'FL'].value)
        leg2_yt = body_yf - Lt*cos(m.thA[i,'FL'].value)
...
def make_realtime_animation(m, N, hm):
    ...
    def plot_board(i,m,ax): #update function for animation
        ...
        leg1_xt = body_xb
        leg1_yt = body_yb
        leg1_xb = body_xb + m.len[('left_leg',1)]*sin(q_thb_interp[i]+q_thl_l_interp[i])
        leg1_yb = body_yb - m.len[('left_leg',1)]*cos(q_thb_interp[i]+q_thl_l_interp[i])
        ax.plot([leg1_xt,leg1_xb],[leg1_yt,leg1_yb],color='k')

        #plot leg 2
        Lt = 0.5*m.len[('left_leg',1)] + q_r_l_interp[i] - 0.5*m.len[('left_leg',2)]
        Lb = 0.5*m.len[('left_leg',1)] + q_r_l_interp[i] + 0.5*m.len[('left_leg',2)]
        leg2_xt = body_xb + Lt*sin(q_thb_interp[i]+q_thl_l_interp[i])
        leg2_yt = body_yb - Lt*cos(q_thb_interp[i]+q_thl_l_interp[i])
        leg2_xb = body_xb + Lb*sin(q_thb_interp[i]+q_thl_l_interp[i])
        leg2_yb = body_yb - Lb*cos(q_thb_interp[i]+q_thl_l_interp[i])
        ax.plot([leg2_xt,leg2_xb],[leg2_yt,leg2_yb],color='k')
        ...
        leg1_xt = body_xf
        leg1_yt = body_yf
        leg1_xb = body_xf + m.len[('right_leg',1)]*sin(q_thb_interp[i]+q_thl_r_interp[i])
        leg1_yb = body_yf - m.len[('right_leg',1)]*cos(q_thb_interp[i]+q_thl_r_interp[i])
        ax.plot([leg1_xt,leg1_xb],[leg1_yt,leg1_yb],color='k')
        ...
        leg2_xt = body_xf + Lt*sin(q_thb_interp[i]+q_thl_r_interp[i])
        leg2_yt = body_yf - Lt*cos(q_thb_interp[i]+q_thl_r_interp[i])
        leg2_xb = body_xf + Lb*sin(q_thb_interp[i]+q_thl_r_interp[i])
        leg2_yb = body_yf - Lb*cos(q_thb_interp[i]+q_thl_r_interp[i])
        ax.plot([leg2_xt,leg2_xb],[leg2_yt,leg2_yb],color='k')
        ax.plot(leg2_xb,leg2_yb,color='m',marker = '.')
